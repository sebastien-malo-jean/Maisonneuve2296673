...
return [
    ...
    | les règles de taille. N'hésitez pas à ajuster chaque message ici.
    |
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Vous pouvez spécifier des messages de validation personnalisés pour des attributs
    ...
    */
    ...
    /*
    |--------------------------------------------------------------------------
    | Lignes d'Attributs Personnalisées
    |--------------------------------------------------------------------------
    |
    | Les lignes ci-dessous sont utilisées pour remplacer les noms des attributs par des
    | versions plus lisibles pour l'utilisateur. Cela permet de simplifier les messages
    | d'erreur et d'améliorer l'expérience utilisateur.
    |
    */
